 ...
 *
 * This interface extends M47StackProps with additional properties required to create a VPC.
 *
 * Properties include:
 ...
 * };
 */
export interface VPCStackProps extends M47StackProps {
    vpcName: string;
    vpcCdir: string;
    maxAzs?: number;
    natGateways?: number;
 ...
 * });
 */
export class VpcStack extends M47Stack {
    ...
    constructor(scope: Construct, props: VPCStackProps) {
        ...
        this.addProjectTags(this.vpc, props);
    }
}
